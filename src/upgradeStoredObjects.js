...
async function main() {
  ...
  do {
    ...
    cwsCode = await axios.get({ method: 'get', url: 'http://ffsld-conversionwebhookserver-service.razeedeploy.svc/readiness' }); // conversion webhook server ready for requests
